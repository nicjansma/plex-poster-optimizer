...
async.waterfall([
    ...
    function(postersToUpdate, cb) {
        ...
        async.eachSeries(postersToUpdate, function(poster, cbEachPoster) {
            ...
            //     //     });
            //     // } else {
            //     //     request(otherPoster.key, function(err, response, data) {
            //     //
            //     //     })
            //     // }
            // },
            // function(err) {
            //     cbEachOtherPoster(err);
            // });
